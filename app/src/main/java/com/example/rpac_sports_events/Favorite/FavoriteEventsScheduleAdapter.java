...
public class FavoriteEventsScheduleAdapter extends RecyclerView.Adapter<FavoriteEventsScheduleAdapter.MyViewHolder> {
    ArrayList<FavoriteEvents> events;
    FavoriteItemClickListener mListener;

    public FavoriteEventsScheduleAdapter(ArrayList<FavoriteEvents> events, FavoriteItemClickListener listener) {
        this.events = events;
